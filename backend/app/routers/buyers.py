...
def get_buyer(buyer_id: str, _: CurrentUserResponse = Depends(get_current_user), session: Session = Depends(get_db)) -> BuyerResponse:
...
def create_opening_payable(buyer_id: str, payload: BuyerLedgerEntryRequest, current_user: CurrentUserResponse = Depends(get_current_user), session: Session = Depends(get_db)) -> BuyerTransactionResponse:
...
def create_purchase_amount(buyer_id: str, payload: BuyerLedgerEntryRequest, current_user: CurrentUserResponse = Depends(get_current_user), session: Session = Depends(get_db)) -> BuyerTransactionResponse:
...
def create_payment_made(buyer_id: str, payload: BuyerLedgerEntryRequest, current_user: CurrentUserResponse = Depends(get_current_user), session: Session = Depends(get_db)) -> BuyerTransactionResponse:
...
def create_payable_adjustment(buyer_id: str, payload: BuyerAdjustmentRequest, current_user: CurrentUserResponse = Depends(get_current_user), session: Session = Depends(get_db)) -> BuyerTransactionResponse:
...
def get_buyer_ledger(buyer_id: str, _: CurrentUserResponse = Depends(get_current_user), session: Session = Depends(get_db)) -> BuyerLedgerResponse:
