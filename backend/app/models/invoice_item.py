...
class InvoiceItem(Base):
    ...
    product_item_number: Mapped[str] = mapped_column(String(255), nullable=False)
    product_item_name: Mapped[str] = mapped_column(Text, nullable=False)
    product_category: Mapped[str] = mapped_column(String(255), nullable=False)
    product_buyer_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), nullable=True)
    product_company_name: Mapped[str] = mapped_column(String(255), nullable=False)
    product_hsn_code: Mapped[str | None] = mapped_column(String(32), nullable=True)
    buying_price: Mapped[Decimal] = mapped_column(Numeric(14, 3), nullable=False)
    selling_price: Mapped[Decimal] = mapped_column(Numeric(14, 3), nullable=False)
    ...
    entered_unit_price: Mapped[Decimal] = mapped_column(Numeric(14, 3), nullable=False)
    unit_price_excl_tax: Mapped[Decimal] = mapped_column(Numeric(14, 3), nullable=False)
    unit_price_incl_tax: Mapped[Decimal] = mapped_column(Numeric(14, 3), nullable=False)
    ...
    buying_amount: Mapped[Decimal] = mapped_column(Numeric(14, 2), nullable=False)
