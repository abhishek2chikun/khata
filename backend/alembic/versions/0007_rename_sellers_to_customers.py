...
def upgrade() -> None:
    ...
    _ensure_column_if_missing("customer_transactions", "opening_balance_customer_id", "UUID")
    ...
    _rename_constraint_if_present("customer_transactions", "seller_transactions_seller_id_fkey", "fk_customer_transactions_customer_id_customers")
    _rename_constraint_if_present("invoices", "invoices_seller_id_fkey", "fk_invoices_customer_id_customers")
...
def downgrade() -> None:
    ...
    _rename_constraint_if_present("customer_transactions", "fk_customer_transactions_invoice_id_invoices", "fk_seller_transactions_invoice_id_invoices")
    _rename_constraint_if_present("invoices", "fk_invoices_customer_id_customers", "invoices_seller_id_fkey")
    _rename_constraint_if_present("customer_transactions", "fk_customer_transactions_customer_id_customers", "seller_transactions_seller_id_fkey")
...
def _ensure_column_if_missing(table_name: str, column_name: str, column_type: str) -> None:
    op.execute(sa.text(f"""
        DO $$
        BEGIN
