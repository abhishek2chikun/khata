...
## Outcome
Invoice PDFs render polished GST/non-GST documents in A5 for at most 10 item rows and A4 for more than 10, with immutable snapshot content and visible cancellation state.
...
- Page format is exactly `items.length <= 10 ? PdfPageFormat.a5 : PdfPageFormat.a4`; line quantity never affects selection.
...
- `uses_a5_for_10_item_rows_in_gst_and_non_gst_modes`: parse media box dimensions. Prevents default-A4 false positive.
...
- Exact 10/11 threshold and line-count definition.
